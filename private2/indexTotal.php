...
<div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Menu Prueba!</span></a>
                    </div>
 ...
 <!-- top navigation -->
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                    ...
                                    <li><a href="login.html"><i class="fa fa-sign-out pull-right"></i> Cerrar</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
    
                            <button class="btn btn-primary pull-right" style="margin-left:10px;margin-top:10px;margin-right: 5px;"><i class="fa fa-users"></i> Ayuda y contacto</button>
                            </li>
            ...
            <div class="right_col" role="main">
                ...
                <footer>
                    <div class="">
                        <p class="pull-right">TEMPLATE MENU bottstrap <a>AMODO</a>. |
                            <span class="lead"> <i class="fa fa-paw"></i> AAMODO!</span>
                        </p>
                    </div>
                    <div class="clearfix"></div>
                </footer>
